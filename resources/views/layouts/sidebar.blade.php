<aside class="fixed inset-y-0 left-0 w-64 bg-primary-900 text-white transition-transform duration-300 transform z-30 overflow-y-auto shadow-2xl border-r border-primary-800">
    <div class="flex items-center justify-center h-20 border-b border-primary-800 bg-primary-950/50 backdrop-blur-sm">
        <div class="flex items-center space-x-3">
             <div class="bg-white p-1 rounded-lg w-8 h-8 flex items-center justify-center shadow-lg shadow-white/10">
               <img src="/imagenes/Vieja.png" alt="FishPot Logo" class="h-6 w-auto">
             </div>
    ...
    <nav class="mt-8 px-4 space-y-2">
        ...
        <a href="#" class="flex items-center px-4 py-3 text-sm font-bold rounded-xl text-primary-100 hover:bg-primary-800 hover:text-white transition-colors">
