    ...
    <div class="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg p-6">
        <form action="{{ route('admin.orders.update', $order) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="total" id="total" value="{{ old('total', $order->total) }}" step="0.01" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                @error('total')
            ...
            {{-- If you want to add product selection for order items here, it would be more complex --}}
